...
export function Sidebar({
  ...
  return (
    ...
    >
      ...
      >
        <div
          className="flex h-full w-full flex-col overflow-hidden bg-sidebar group-data-[variant=floating]:rounded-2xl group-data-[variant=floating]:shadow-card"
          data-sidebar="sidebar"
...
export function SidebarMenuSkeleton({
  ...
  const width = React.useMemo(() => {
    // eslint-disable-next-line react-hooks/purity -- upstream coss ui uses a random skeleton width; memoized so it stays stable per mount.
